...
Bumping is **not** done by hand-editing `solution.xml`. Use `dgtp maintenance solution-version`,
...
Because of this, **the assembly version must increase on every build that gets pushed**,
