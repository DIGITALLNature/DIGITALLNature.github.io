...
**`DGT-SRV-120`**{ #dgt-srv-120 } — Prefer **[Custom APIs](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/custom-api)** over classic unbound/bound Actions for new server-side operations
