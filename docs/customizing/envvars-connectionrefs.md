...
- For unattended/production flows, assign the connection via an **application user / service
...
- In development, create the environment variable **definition only** (no value) and deploy
