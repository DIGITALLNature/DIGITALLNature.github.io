...
- Brand **per app**, using the modern model-driven app theme (logo, colors set on the app),
...
- Use **SVG web resources** for table and command-bar icons — vector scales cleanly across the
