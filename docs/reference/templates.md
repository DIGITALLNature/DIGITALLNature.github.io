...
Full files, where other chapters only show an excerpt.

## `.editorconfig`

Referenced from [Project Setup](../coding/serverside/project-setup.md).
...
Referenced from [Source Control](../alm/source-control.md#gitattributes).
